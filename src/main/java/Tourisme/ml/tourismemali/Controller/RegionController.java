...
import Tourisme.ml.tourismemali.Models.*;
import Tourisme.ml.tourismemali.Services.*;
...
public class RegionController {
    ...
    @Autowired
    private LanguesService Lservice;
    ...
    public ResponseEntity<Object> CreerRegion(@RequestBody Region region) {
        ...
        if (verif_RegionCode == null && verif_RegionName == null) {
            ...
            Langues langue = Lservice.findByLibele(region.getLangue().getLibele());
    ...
    // methode pour la surppression d'une Region
